export default {
  ...
  colors: {
    ...
    heading: '#5623C4', // primary heading color - was #244886
    heading_secondary: '#0F2137', // heading color
    background: '#FFFFFF', // body background color
    background_secondary: '#F9FBFD', // secondary background color
    border_color: '#E5ECF4', // border color
    primary: '#6228DD', // purple; primary button and link color
    secondary: '#5422BF', // #25CB9E secondary color - can be used for hover states
    tertiary: '#FFB586', // contrast color accent
    muted: '#7B8188', // muted color
    accent: '#609', // a contrast color for emphasizing UI
    yellow: '#F6C416',
    grey: '#f0f3f5', // grey colour
    error: '#dd2849', // error message color
  ...
  text: {
    ...
    heroPromo: {
      color: 'tertiary',
      fontSize: ['10px',null, null, '12px','12px','12px','12px'],
      fontWeight: 500,
      pr: [0, null, null, null, null, '100px', null, '125px'],
      width: ['300px', '350px','400px','400px','500px','600px','650px'],
      mb: ['10px']
    },
    title: {
  ...
  buttons: {
    ...
    defaultBtn: {
      ...
      padding: ['0.625em 1.5em', null, null, null, '0.625em 1.5em'],
      fontFamily: 'body',
      cursor: 'pointer',
      lineHeight: 1.2,
